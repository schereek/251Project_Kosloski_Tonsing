...
Interpretation: The age groups with the highest infection rate are those over 65 year of age followed by those 18-64 years. Given that the risk is does not strictly increase or decrease proportional with age which would be more likely to suggest a biological basis for difference in infection rate, behavioral differences between the age strata should be examined as part of selecting risk reduction strategies.
